...
| TTS（audio.cpp） | **~1 GB** | **暂停 0 GB** | 实时语音 |
| **合计** | **~43 GB ✅** | **~30-36 GB ✅** | |
...
```
骏马(22G) + ComfyUI(8-14G) + API 替代巡检+TTS = 30-36G ✅
```
...
|:-----|:-------------------|:---------------------|
| TTS | 本地 audio.cpp | API 调用（DeepSeek / Azure） |
